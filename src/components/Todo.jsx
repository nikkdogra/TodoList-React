...
function Todo({ id, title, description, completed, pinned }) {
    ...
    return (
        <div className="d-flex justify-content-between align-items-center my-3 py-md-2 px-md-4 p-2 position-relative" style={{ background: mode === 'light' ? 'lightblue' : '#333' }} onDoubleClick={() => todosDispatch({ type: 'pin', id: id })}>
