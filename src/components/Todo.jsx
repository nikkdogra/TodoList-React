function Todo({ id, title, description, completed, pinned, onDeleteTodo, onCompleteTodo, on_Edit_Icon_Click, mode, onPinTodo }) {
    return (
        <div className="d-flex justify-content-between align-items-center my-3 py-2 px-4 position-relative" style={{ background: mode === 'light' ? 'lightblue' : '#333' }} onDoubleClick={() => onPinTodo(id)}>
